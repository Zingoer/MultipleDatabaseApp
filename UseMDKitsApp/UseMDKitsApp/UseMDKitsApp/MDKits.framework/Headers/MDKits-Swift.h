...
SWIFT_CLASS("_TtC6MDKits14CoreDataStack2")
@interface CoreDataStack2 : NSObject
...
SWIFT_CLASS("_TtC6MDKits12SecondEntity")
@interface SecondEntity : NSManagedObject
...
@interface SecondEntity (SWIFT_EXTENSION(MDKits))
@property (nonatomic, copy) NSString * __nullable age;
@end
